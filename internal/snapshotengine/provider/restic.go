...
func (r *resticProvider) InitRepo(_ context.Context, param RepoParam) error {

	return nil
}

// ConnectToRepo establishes connection to an existing repository
func (r *resticProvider) ConnectToRepo(_ context.Context, param RepoParam) error {

	return nil
}

// updateBackendFromTarget updates the backend configuration with OnlineSnapshotTarget information
func (r *resticProvider) updateBackendFromTarget(param RepoParam) error {
	return nil
}

// PrepareRepo combines InitRepo and ConnectToRepo
func (r *resticProvider) PrepareRepo(_ context.Context, param RepoParam) error {
	return nil
}

// BoostRepoConnect re-ensures local connection to the repo
func (r *resticProvider) BoostRepoConnect(_ context.Context, _ RepoParam) error {
	// Restic doesn't require explicit re-connection
	return nil
}

// EnsureUnlockRepo removes any stale file locks
func (r *resticProvider) EnsureUnlockRepo(_ context.Context, param RepoParam) error {
	return nil
}

// PruneRepo performs full maintenance/pruning
func (r *resticProvider) PruneRepo(_ context.Context, param RepoParam) error {
	return nil
}
...
func (r *resticProvider) Restore(_ context.Context, param RestoreParam) error {
	return nil
}

// ListSnapshots lists all snapshots in the repository
func (r *resticProvider) ListSnapshots(_ context.Context, param RepoParam) ([]SnapshotInfo, error) {
	return nil, nil
}

// DeleteSnapshot deletes a specific snapshot by ID
func (r *resticProvider) DeleteSnapshot(_ context.Context, snapshotID string, param RepoParam) error {
	return nil
}

// Forget removes a snapshot from the repository
func (r *resticProvider) Forget(ctx context.Context, snapshotID string, param RepoParam) error {
	return nil
}

// BatchForget removes multiple snapshots
func (r *resticProvider) BatchForget(_ context.Context, snapshotIDs []string, param RepoParam) []error {
	return []error{}
}

// CheckRepository verifies the repository integrity
func (r *resticProvider) CheckRepository(_ context.Context, param RepoParam) error {
	return nil
}

// DefaultMaintenanceFrequency returns the default frequency to run maintenance
func (r *resticProvider) DefaultMaintenanceFrequency(_ context.Context, _ RepoParam) time.Duration {
	// Default maintenance frequency for restic is 7 days
	return 7 * 24 * time.Hour
}

// GetRepositoryStats returns statistics about the repository
func (r *resticProvider) GetRepositoryStats(_ context.Context, param RepoParam) (*RepositoryStats, error) {
	return nil, nil
}
